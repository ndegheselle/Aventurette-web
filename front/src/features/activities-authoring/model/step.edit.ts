...
/**
 * The step seen from its author's side: the blank one written on add, the materials offered,
 * and how many files it takes. Its shape stays in `activities/model`.
 */
